...
const componentConfigCards = [
	...
	{ title: "Embedding", value: "openai / text-embedding-3-small / 1536", detail: "provider + model + dim" },
	{ title: "Splitter", value: "recursive_character / chunk_size=1000 / overlap=150", detail: "type + chunk_size + overlap" },
	{ title: "Reranker", value: "cross_encoder / bge-reranker-v2-m3", detail: "backend + model" },
...
const healthMetrics = [
	{ title: "最近 Ingestion Trace", value: "2026-03-16 14:58:42", sub: "总耗时 23.8s" },
	{ title: "最近 Query Trace", value: "2026-03-16 15:08:11", sub: "总耗时 1.42s" },
	{ title: "Trace 存储状态", value: "PostgreSQL + JSONL 镜像", sub: "obs_traces / obs_trace_stages" },
];

const totalDocuments = collectionStats.reduce((acc, item) => acc + item.documents, 0);
...
<template>
	<section class="overview-panel" data-page-id="overview">
		<header class="hero-head">
			<div>
				<h1>系统总览</h1>
				<p>页面内容按 DEV_SPEC 3.5.5 定义：组件配置卡片、数据资产统计、系统健康指标。</p>
			</div>
		...
		<article class="panel-card">
			...
			<div class="config-grid">
				<div v-for="item in componentConfigCards" :key="item.title" class="config-card">
		...
		<div class="lower-grid">
			...
			<article class="panel-card">
				...
				<div class="health-list">
					<div v-for="item in healthMetrics" :key="item.title" class="health-item">
